namespace Entities.Migrations
{
    ...
    public partial class ModifyViewEvaluationValueCurrency : DbMigration
    {
                    ...
                    json_table(c.history, '$' NULL ON ERROR
                                          columns(
                                                   ...
                                                   columns(
                                                            ...
                                                            District varchar path '$.District.Name',
                    ...
                    left join collateralagreements cag on cca.collateralagreementid = cag.id,
                                ...
                                json_table(c.body, '$' NULL ON ERROR
                                                   columns(
                                                            ...
                                                            District varchar path '$.District.Name',
                                                            Specification varchar path '$.Specification',
                                                            Value varchar path '$.Evaluation.Value.Value',
                                                            Currency varchar path '$.Evaluation.Value.Currency.Name',
