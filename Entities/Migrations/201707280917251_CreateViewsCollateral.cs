namespace Entities.Migrations
{
    ...
    public partial class CreateViewsCollateral : DbMigration
    {
        public override void Up()
        {
            ...
            this.Sql(@"
                    ...
                    from
                          COLLAGREEMENTS_CREDAGREEMENTS cca
                          join COLLATERAL_COLLGREEMENTS ca on cca.COLLATERALAGREEMENTID = ca.collateralagreementid
                          join collateral c on ca.collateralid = c.id
                          join collateralagreements cag on cca.collateralagreementid = cag.id,
